...
| [0004](0004-use-renovate-for-dependency-updates.md)    | Use Renovate for Dependency Updates with Per-Template Baselines | Accepted | 2026-06-02 | Adopt Renovate org-wide; each type-template owns a self-contained `.github/renovate.json5`; consumers extend explicit preset paths. No org-level Renovate config. Replaces Dependabot. |
